...
5. Write the result to `projects/<book>/style/style-fingerprint.md` using the schema.
6. Fill the **slop-marker reconciliation** section so `slop-check` knows which generic rules this voice intentionally breaks.
